# cc_net
### NOTE: I made this fork work without an aws account with limited functionality on debug mode. I do plan to just rewrite it to make it work in normal mode but lets see.....
